...
namespace _Common.Scheduling.Cron
{
    [Serializable]
    public sealed class CrontabFieldImpl : IObjectReference
    {
        ...
        public static readonly CrontabFieldImpl Month = new CrontabFieldImpl(
        ...
        public static readonly CrontabFieldImpl DayOfWeek = new CrontabFieldImpl(
            ...
            if (!Enum.IsDefined(typeof(CrontabFieldKind), kind))
            {
                throw new ArgumentException(
                    string.Format(
                        ...
                        string.Join(", ", Enum.GetNames(typeof(CrontabFieldKind)))),
                    nameof(kind));
            }
        ...
        private static void ThrowParseException(Exception innerException, string str)
        {
            ...
            throw new FormatException(
                string.Format("'{0}' is not a valid crontab field expression.", str),
                innerException);
        }
