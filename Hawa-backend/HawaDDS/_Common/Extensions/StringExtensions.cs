...
namespace _Common.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// </summary>
        public static string EnsureEndsWith(this string str, string c)
        {
        ...
        /// Adds a char to end of given string if it does not ends with the char.
        /// </summary>
        public static string EnsureEndsWith(this string str, string c, StringComparison comparisonType)
        {
            if (str == null)
            {
        ...
        /// Adds a char to end of given string if it does not ends with the char.
        /// </summary>
        public static string EnsureEndsWith(this string str, string c, bool ignoreCase, CultureInfo culture)
        {
            if (str == null)
            {
                throw new ArgumentNullException(nameof(str));
        ...
        /// Adds a char to beginning of given string if it does not starts with the char.
        /// </summary>
        public static string EnsureStartsWith(this string str, string c, bool ignoreCase, CultureInfo culture)
        {
            if (str == null)
            {
        ...
        /// </summary>
        public static string[] SplitBy(this string str, string separator)
        {
            return !str.IsNullOrWhiteSpace() ? str.Split(new[] { separator }, StringSplitOptions.RemoveEmptyEntries) : EmptyArray<string>.Instance;
        }
        ...
        /// <summary>
        /// Converts string to nullable enum value.
        /// </summary>
        /// <typeparam name="T">Type of enum</typeparam>
        /// <param name="value">String value to convert</param>
        /// <returns>Returns nullable enum object</returns>
        ...
        {
            int result;
            return !string.IsNullOrWhiteSpace(value) && int.TryParse(value.Trim(), out result) ? result : (int?)null;
        }
    }
}