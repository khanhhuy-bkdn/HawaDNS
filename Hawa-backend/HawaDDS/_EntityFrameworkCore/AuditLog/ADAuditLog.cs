...
namespace _EntityFrameworkCore.AuditLog
{
    ...
    /// </summary>
    [Table("ADAuditLogs")]
    public class ADAuditLog : IFullEntity
    {
        /// <summary>
        ...
        /// </summary>
        public static int MaxParametersLength = 2000;
        ...
        public static ADAuditLog CreateFromAuditInfo(AuditInfo auditInfo)
        {
            var exceptionMessage = auditInfo.Exception.GetExceptionTechnicalInfo();
            return new ADAuditLog
            {
                UserId = auditInfo.UserId.GetValueOrDefault(),
